      ...
      <div className="container">
        ...
        <div className="header_row container-with">
          <div className="col-1">
            <Link to="/">
              <img
                src="https://minimalin-demo.myshopify.com/cdn/shop/files/logo-simple-10_150x.png?v=1708142290"
                alt=""
                className="logo"
              />
            </Link>
          ...
          <div className="col-2">
            <ul className={`navbar ${isNavbarOpen ? "active" : ""}`}>
              ...
              <li className="nav-items cat-main">
      ...
      <img className='cat-image' src="cat-row2-img-4.webp" alt="" />
          ...
          <div className="col-3">
            <div className="dropdown-menu">
              <span className="dropdoen-inr">
                IN (INR ₹)<i class="fa-solid fa-chevron-down"></i>
              </span>
            ...
            <div
              className="cart-icon  cart-item-count"
